  ...
  return (<section className="w-screen h-screen">
    <div className="container mx-auto flex flex-col justify-center items-center h-full">
      <div className="py-30 md:py-40">
        <Link href="/pages" passHref><Image className="cursor-pointer" src="/assets/images/logo-green.svg" width={250}
                                            height={71} alt="Frontier logo"/></Link>
      </div>
      ...
      <p className="text-16 text-light-500 mt-30 md:mt-40 xl:mt-60 text-center">
        You can still contact us via <a className="text-primary" href="https://www.instagram.com/frontier">Instagram</a>,
        by email at <a className="text-primary" href="mailto:jieli@frontier.com">jieli@frontier.com</a> or by phone at <a
      ...
      <div className="flex flex-col md:flex-row justify-between py-20 md:pb-40 md:pt-80 text-10 w-full">
        <p className="text-center">© 2021. frontier.com. All rights reserved.</p>
