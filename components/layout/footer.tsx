      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-3 gap-20">
          <div className="mb-40 lg:mb-0">
            <Link href="/pages"><a><Image src="/assets/images/logo-green.svg" height={37} width={130} alt="Frontier logo"/></a></Link>
            <div className="flex flex-col font-medium mt-30 lg:mt-65">
              <p className="text-white">Your Trusted Crypto Reward</p>
              <a href="mailto:jieli@frontier.com" className="text-warning">jieli@frontier.com</a>
            ...
            <div className="grid lg:grid-cols-4 mt-5">
              ...
              <div>
                ...
                <div className="d-flex justify-center lg:justify-start">
                  <Link href="https://www.facebook.com/frontier" passHref><a className="mr-35">Facebook</a></Link>
                  <Link href="https://www.instagram.com/frontier" passHref><a className="mr-35">Twitter</a></Link>
                  <Link href="https://www.pinterest.com/frontier" passHref><a>Telegram</a></Link>
                </div>
        ...
        <div className="lg:flex justify-between mt-20 leading-10">
          <p>© 2022 Frontier. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
